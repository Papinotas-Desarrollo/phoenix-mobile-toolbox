import { sa } from '../utils/safeAccess';
...
export const showLog = (logObject: Object, name: String = '', cb: Function = () => {}) => __DEV__ && process.env.NODE_ENV !== 'test' && sa(logObject, name, false) && cb();
